...
import { BackupError, backupFile, generateRemoteLink, } from "../../src/services/backupService.js";
...
describe("backupService", () => {
    ...
    it("fails when rclone returns a non-zero exit code", async () => {
        ...
        await expect(backupFile(tempFile, "gdrive:backups")).rejects.toThrow(BackupError);
    });
    it("returns a generated remote link", async () => {
        ...
        await expect(generateRemoteLink("gdrive:backups/file.jpg")).resolves.toBe("https://example.com/file");
    });
});
